...
//	["Encryption",		"encryptionTestingPage.html",	"Encryption Testing",	1	],
	["Color&nbsp;2",	"experimental/colorPage2.html",	"2 Color Testing",		1	],
	["Color&nbsp;3", 	"experimental/colorPage3.html",	"3 Color Testing",		1	] ];
var home = false;
...
if(true)
{
	...
	for(; c<len; c++){
		...
		if(s==headerList[c][1]){
			temp2 = "\" href=\""+headerList[c][1]+"\" style=\"background-color:#414444\" title=\""
		...
		if(headerList[c][3]==1){//left align
			newHTML += temp1+"h0_button h0b_colors h0_left"+temp2;
			newMenuHTML += temp1+"h0_menu_button h0b_colors"+temp2;
		}
		else if(headerList[c][3]==2){//right align
			newHTML += temp1+"h0_button h0b_colors h0_right"+temp2;
			newMenuEndHTML += temp1+"h0_menu_button h0b_colors"+temp2;
		}
		else if(headerList[c][3]==3){//important right align
			newFrontHTML += temp1+"h0_button h0b_colors h0_right"+temp2;
			newMenuEndHTML += temp1+"h0_menu_button h0b_colors"+temp2;
		}
		else{
