...
[   //["[>_]", 			"javascript:changeTerminal();",	"terminal",				2	],
	...
	["Color2", 			"colorPage2.html",	"2 Color Testing",		1	],
	["Color3", 			"colorPage3.html",	"3 Color Testing",		1	],
	["",				"",								"Spacer",				4	] ];/**/
...
function doTheHeaderThing(){//Changes the header when scrolling
	...
	if(scrollNum<90){
		...
		document.getElementById("header_pic_link").style.width = 142-(scrollNum*(29/45));
		//document.getElementById("header_pic_link").style = "display:inline";
		if(home){
		...
		document.getElementById("header_pic_link").style.width = 84;
		//document.getElementById("header_pic_link").style = "display:none";
		if(home){
			document.getElementById("header_pic").className = "this_page";//"header_pic_button";
		}
	}
}
